 ...
 */
function AdminDashboardContent({ adminData }: { adminData: AdminDashboardData }) {
  const { user, stats, recentActivity } = adminData;
    ...
    <div className='space-y-6'>
      ...
      <div className='bg-white rounded-lg shadow p-6'>
        ...
        <p className='text-gray-600'>
          Welcome back, {user.profile?.fullName || user.email}. System overview and administrative controls.
        </p>
      </div>
        ...
        <div className='bg-white rounded-lg shadow p-6'>
          <div className='flex items-center'>
            ...
            <div className='ml-4'>
              ...
              <p className='text-2xl font-semibold text-gray-900'>{stats.activeEnrollments.toLocaleString()}</p>
            </div>
          </div>
        </div>
