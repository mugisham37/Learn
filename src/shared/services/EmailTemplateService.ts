...
export class EmailTemplateService {
  ...
  private loadTemplates(): void {
    ...
    // Additional payment notification templates
    this.registerTemplate({
      id: 'payment_succeeded',
      name: 'Payment Successful',
      subject: 'Payment successful for {{courseName}}',
      htmlContent: [
        '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">',
    ...
    this.registerTemplate({
      ...
      htmlContent: [
        ...
        '  <div style="text-align: center; margin: 30px 0;">',
        '    <a href="{{retryUrl}}" style="background-color: #dc2626; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; display: inline-block;">',
        '      Retry Payment',
        '    </a>',
        '  </div>',
        '</div>',
    ...
    this.registerTemplate({
      ...
      htmlContent: [
        ...
        '  </div>',
        '  <p>You will continue to have access to your courses until {{accessUntil}}.</p>',
    ...
    this.registerTemplate({
      ...
      htmlContent: [
        '<div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">',
        '  <h1 style="color: #dc2626;">Subscription Payment Failed</h1>',
        '  <p>Hi {{studentName}},</p>',
