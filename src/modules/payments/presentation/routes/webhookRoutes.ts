...
export async function registerWebhookRoutes(fastify: FastifyInstance): Promise<void> {
  ...
  const { PaymentRepository } =
    await import('../../infrastructure/repositories/PaymentRepository.js');
  const { SubscriptionRepository } =
    await import('../../infrastructure/repositories/SubscriptionRepository.js');
  const { RefundRepository } =
    await import('../../infrastructure/repositories/RefundRepository.js');
  const { EnrollmentRepository } =
    await import('../../../enrollments/infrastructure/repositories/EnrollmentRepository.js');
  const { CourseRepository } =
    await import('../../../courses/infrastructure/repositories/CourseRepository.js');
  const { UserRepository } =
    await import('../../../users/infrastructure/repositories/UserRepository.js');
