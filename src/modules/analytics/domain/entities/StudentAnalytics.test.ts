...
describe('StudentAnalytics', () => {
  ...
  it('should throw error for invalid skill rating', () => {
    ...
    expect(() => analytics.updateSkillRating('python', 150)).toThrow(
  ...
  it('should throw error for negative values', () => {
    ...
    expect(() => new StudentAnalytics(invalidData)).toThrow(
      'StudentAnalytics: totalCoursesEnrolled cannot be negative'
    );
  });
});
