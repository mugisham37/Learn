...
export class CertificateGeneratorService implements ICertificateGenerator {
   ...
   */
  async generateCertificate(enrollment: Enrollment, data: CertificateGenerationData): Promise<Certificate> {
  ...
  private designCertificate(
    ...
    doc.moveTo(pageWidth * 0.3, titleY)
    ...
    // Signature line
    doc.moveTo(margin + 100, signatureY + 25)
