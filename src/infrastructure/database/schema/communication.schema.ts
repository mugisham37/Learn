...
export const discussionThreads = pgTable('discussion_threads', {
  ...
  courseActivityIdx: index('discussion_threads_course_activity_idx').on(table.courseId, table.lastActivityAt),
}));
...
export const discussionPosts = pgTable('discussion_posts', {
  ...
  threadCreatedIdx: index('discussion_posts_thread_created_idx').on(table.threadId, table.createdAt),
}));
...
export const announcements = pgTable('announcements', {
  ...
  coursePublishedIdx: index('announcements_course_published_idx').on(table.courseId, table.publishedAt),
}));
