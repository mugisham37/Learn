 ...
 */
export function sanitizeByContentType(content: string, contentType: string): string {
  const sanitizer =
    CONTENT_SANITIZATION_MAP[contentType as keyof typeof CONTENT_SANITIZATION_MAP] ||
